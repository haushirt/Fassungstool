...
37 Einträge in `src/gnmap.js`: 16 zeigen auf einen Artikel, 21 sind
...
- Neu `node tests/ui-runde22.cjs`: **21 von 21** im echten Browser
  gegen echten Worker und echte SQLite. Darin gemessen: 15 statt 44
  offene Namen in Bericht 37, ein Klick schreibt 33 Zeilen in die
...
die Zuordnungstabelle bleibt, wie sie ist. `sw.js` steht auf **v68**.
